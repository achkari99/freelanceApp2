...
export const project = {
  ...
  excerpt: "An AI assistant for clinicians reviewing lab results, built with privacy-first data orchestration. Full case study releasing soon.",
...
_Sign up for Lab Notes to see the prototypes, safety reviews, and pilot outcomes as they drop._
